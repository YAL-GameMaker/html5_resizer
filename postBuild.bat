...
set extName=html5_resizer
set dllName=html5_resizer
set gmlDir14=%solutionDir%html5_resizer.gmx
set gmlDir22=%solutionDir%html5_resizer_yy
set gmlDir23=%solutionDir%html5_resizer_23
